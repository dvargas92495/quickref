const data = [
    ...
    "header": {"c1": "Action", "c2": "Primary", "c3": "Alternatives" },
     "items": [
                ...
                { "c1": "",                     "c2": "",             "c3": "Alt-j h" },
                { "c1": "",                     "c2": "",             "c3": "CMD-j h" },
                { "c1": "Toggle Deep Nav <em>(must be enabled)</em>",      "c2": "Alt-g or g",        "c3": "Alt-g or g" },
...

  {
    ...
    "header": {"c1": "Action", "c2": "Windows", "c3": "Mac" },
     "items": [
                ...
                { "c1": "Next day's note",              "c2": "Ctrl-Alt-n", "c3": "" },
                { "c1": "Previous day's note",          "c2": "Ctrl-Alt-p", "c3": "" },       
  ...
  },
  {
    ...
    "header": {"c1": "Action", "c2": "Windows", "c3": "Mac" },
     "items": [
                ...
                { "c1": "Toggle Block Reference expansion", "c2": "Ctrl-C <small>⇒</small> Ctrl-R",  "c3": "Ctrl-C <small>⇒</small> Ctrl-R" },
